...
export default function OurServicesComponents() {
    return (
        <div className="grid grid-cols-2 max-sm:gap-8 max-lg:gap-6 gap-5 mx-auto px-0">
            ...
            >
                <Image src={shaddow} alt="" className="absolute left-0 bottom-0 z-0 opacity-60" aria-hidden="true" loading="lazy" />
                <Image src={shaddow2} alt="" className="absolute left-0 top-0 z-0 opacity-60" aria-hidden="true" loading="lazy" />
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center z-10 text-center lg:text-left">
                    ...
                    >
                        We design and build custom <strong>ERP systems</strong>, <strong>CRM platforms</strong>, and <strong>business intelligence dashboards</strong> that give you real-time visibility and control. Automate workflows, track performance, and make smarter decisions with tailored management systems built around your specific business requirements.
                    </p>

                    <div className="sr-only">
                        <span itemProp="category">Enterprise Software Development</span>
                        <span itemProp="serviceType">Custom Management Systems</span>
            ...
            >
                ...
                <div className="w-full h-[252px] max-sm:h-max relative overflow-hidden flex flex-col justify-center max-sm:p-6 pt-8 p-12">
                    <Image src={shaddow2} alt="" className="absolute left-0 bottom-0 z-0 opacity-60" aria-hidden="true" loading="lazy" />
                    <Image src={rightshadoow} alt="" className="absolute -right-20 z-0 opacity-60" aria-hidden="true" loading="lazy" />
                    ...
                    <p
                        ...
                        itemProp="description"
                    >
                        Deploy and scale with confidence using <strong>cloud-native infrastructure</strong> and advanced <strong>DevOps practices</strong>. Our CI/CD pipelines, auto-scaling solutions, and 24/7 monitoring keep your systems secure, reliable, and ready for growth.
                    </p>

                    <div className="sr-only">
                        <span itemProp="category">Cloud Services</span>
                        <span itemProp="serviceType">DevOps and Infrastructure</span>
            ...
            <AnimateOnView animation="right"
                ...
                <div className="w-full h-[252px] max-sm:h-max relative overflow-hidden flex flex-col justify-center max-lg:p-6 max-sm:pt-8 p-12">
                    ...
                    <p
                        ...
                        itemProp="description"
                    >
                        Unlock the power of <strong>artificial intelligence</strong> with tools that optimize efficiency and decision-making. From predictive analytics and intelligent chatbots to automated workflows, we integrate <strong>AI solutions</strong> that streamline operations and enhance customer experiences.
                    </p>

                    <div className="sr-only">
                        <span itemProp="category">Artificial Intelligence</span>
                        <span itemProp="serviceType">AI Integration and Automation</span>
            ...
            >
                <Image src={shaddow} alt="" className="absolute left-0 bottom-0 z-0 opacity-60" aria-hidden="true" loading="lazy" />
                <Image src={shaddow2} alt="" className="absolute left-0 top-0 z-0 opacity-60 max-sm:hidden" aria-hidden="true" loading="lazy" />
                ...
                <div className="max-lg:w-full h-max w-1/2 flex flex-col justify-center z-10 text-center lg:text-left order-2 lg:order-1">
                    ...
                    <p
                        ...
                        itemProp="description"
                    >
                        We create high-performance <strong>mobile applications</strong> for <strong>iOS and Android</strong> that combine sleek design with flawless functionality. Whether it&lsquo;s a consumer-facing app or enterprise tool, we deliver intuitive experiences that keep users engaged and businesses connected.
                    </p>

                    <div className="sr-only">
                        <span itemProp="category">Mobile Development</span>
                        <span itemProp="serviceType">iOS and Android App Development</span>
            ...
            {/* Web Development */}
            <AnimateOnView animation="up" className="col-span-2 h-[400px] max-lg:h-[560px] max-md:h-[425px] rounded-xl flex flex-col-reverse lg:flex-row justify-between items-center gap-6 sm:gap-8 lg:gap-20 bg-[#0E1330]/95 border-2 border-[#282D45] p-4 sm:p-8 lg:p-16 relative overflow-hidden"
            >
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center z-10 relative text-center lg:text-left">
                    <Image src={rightshadoow} alt="" className="absolute right-0 bottom-0 z-0 opacity-60" aria-hidden="true" loading="lazy" />
                    <Image src={rightshadoow} alt="" className="absolute right-0 top-0 z-0 opacity-60" aria-hidden="true" loading="lazy" />
                    ...
                    <p
                        ...
                        itemProp="description"
                    >
                        Our team delivers modern, scalable, and secure <strong>websites</strong> and <strong>web applications</strong> that perform exceptionally. From corporate sites to e-commerce platforms, we build <strong>SEO-optimized</strong>, responsive web solutions designed for growth and reliability.
                    </p>

                    <div className="sr-only">
                        <span itemProp="category">Web Development</span>
                        <span itemProp="serviceType">Custom Website Development</span>
