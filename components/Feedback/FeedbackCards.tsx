...
const Feedback = [
    ...
    },
    {
        id: 3,
        description:
            "Penta Studio understood our vision from day one. They translated complex ideas into a clean, scalable product that exceeded our expectations.",
        name: "Ahmed Salah",
    ...
    },
    {
        id: 4,
        description:
            "What impressed us most was their commitment to quality and details. Every feature was thoughtfully built with the end user in mind.",
        name: "Sara Mostafa",
    ...
    },
    {
        id: 5,
        description:
            "The collaboration was smooth, transparent, and highly professional. Penta Studio felt more like a strategic partner than just a service provider.",
        name: "Mohamed Adel",
    ...
    },
    {
        id: 6,
        description:
            "From planning to execution, the team showed deep technical knowledge and strong problem-solving skills. The final result speaks for itself.",
    ...
    },
    {
        id: 7,
        description:
            "They delivered exactly what we needed, on time and within scope. Communication was clear, and every update made us confident in the progress.",
    ...
    },
    {
        id: 8,
        description:
            "Penta Studio helped us turn an early-stage idea into a real, market-ready product. Their guidance was invaluable throughout the journey.",
        name: "Maha Youssef",
        title: "Entrepreneur",
        img: null,
    },
    {
        id: 9,
        description:
            "Professional, reliable, and highly skilled. The team consistently went above and beyond to ensure the best possible outcome.",
    ...
    },
    {
        id: 10,
        description:
            "Choosing Penta Studio was one of our best decisions. Their structured approach and technical excellence gave us confidence at every step.",
    ...
    },
    {
        id: 11,
        description:
            "The level of dedication and ownership the team showed was remarkable. They truly cared about the success of our product.",
    ...
    },
    {
        id: 12,
        description:
            "Penta Studio delivered a high-quality solution that aligned perfectly with our business goals. We look forward to working together again.",
                    ...
                    {Feedback.map((feedback) => (
                        <SwiperSlide key={feedback.id}>
                            <motion.div
                                ...
                                className="w-full max-w-[450px] mx-auto max-sm:w-[280px] h-auto min-h-[300px] max-md:min-h-[290px] bg-[#0E2334] flex flex-col justify-between rounded-3xl py-6 border-2 border-transparent hover:border-[#29E68B] duration-300 hover:transform hover:shadow-[0_10px_30px_5px_#0D2834] cursor-pointer"
                            >
                                ...
                                <div className="flex items-center gap-3 px-12 max-sm:px-6">
                                    <div className="relative w-14 h-14 max-md:w-12 max-md:h-12 rounded-full overflow-hidden flex-shrink-0">
                                        {feedback.img ? (
                                            <Image
